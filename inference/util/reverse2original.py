...
def encode_segmentation_rgb(segmentation, no_neck=True):
    ...
    face_part_ids = [1, 2, 3, 4, 5, 6, 10, 12, 13, 17] if no_neck else [1, 2, 3, 4, 5, 6, 7, 8, 10, 12, 13, 14, 17] # ours
    mouth_id = 11
    # hair_id = 17
...
def reverse2wholeimage(b_align_crop_tenor_list,swaped_imgs, mats, crop_size, oriimg, save_path = None, \
                    pasring_model =None,norm = None, use_mask = False, blend=True):
