...
def encode_segmentation_rgb(segmentation, no_neck=True):
    ...
    hair_border_map = np.ones([parse.shape[0], parse.shape[1]])
    bar_map = np.zeros([int(parse.shape[0]//k), parse.shape[1]])
    hair_border_map[:int(parse.shape[0]//k),] = bar_map
    
    # hair_border_map = hair_border_map * bar_map
    ...
    face_map = face_map * hair_border_map
